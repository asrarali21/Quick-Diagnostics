...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#a4b4d9] flex justify-center pt-20 pb-10 px-4">
       ...
       ⚡ Demo Note: Backend may take 2-3 minutes to respond on first request (Render free tier)
          ...
          <form className="space-y-5" onSubmit={handleRegistersubmit}>
            ...
            <div>
              ...
              <div className="border-b border-gray-400 focus-within:border-[#647FBC] transition-colors">
                <input
                  id="firstName"
                  name="firstName"
                  type="text"
